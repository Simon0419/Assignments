...
class textExtract {
	...
	function getPageCode() {
		...
		//$curl = curl_init();
		//curl_setopt($curl, CURLOPT_URL, 'http://pic.twitter.com/wxQmXeOc0f'); 
	...
	function preProcess() {
		...
		//Title
		$pattern = '/<[t|T]itle>([\d\D]*)<\/[t|T]itle>/iU';
		preg_match_all($pattern,$this->rawPageCode,$cTitle);
		//var_dump($cTitle);
		$this->title = $cTitle[1][0];
        //echo $this->title;
		//$replacement = '';
